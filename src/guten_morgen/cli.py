...
def events_update(
    ...
    try:
        ...
        # Set what the user explicitly supplied, then backfill the rest of the quartet from the
        # existing event, matching "only change what I asked you to change".
